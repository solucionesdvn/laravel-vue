...
import { type BreadcrumbItem } from '@/types'; // si no lo tienes, crea este tipo
...
const form = useForm({
  ...
  address: '',
  nit: '',
  notes: '', // ➕ Campo adicional para notas
});
    ...
    <div class="p-6 max-w-2xl mx-auto">
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div>
          ...
          <input id="name" v-model="form.name" type="text" class="mt-1 block w-full rounded border-gray-300" />
        ...
        <div>
          ...
          <input id="contact_name" v-model="form.contact_name" type="text" class="mt-1 block w-full rounded border-gray-300" />
        ...
        <div>
          ...
          <input id="email" v-model="form.email" type="email" class="mt-1 block w-full rounded border-gray-300" />
        ...
        <div>
          ...
          <input id="address" v-model="form.address" type="text" class="mt-1 block w-full rounded border-gray-300" />
        ...
        <div>
          ...
          <input id="nit" v-model="form.nit" type="text" class="mt-1 block w-full rounded border-gray-300" />
        ...
        <div>
          ...
          <textarea id="notes" v-model="form.notes" rows="4" class="mt-1 block w-full rounded border-gray-300"></textarea>
